...
use App\Http\Controllers\DepartmentController as DeptController;
...
/*
|--------------------------------------------------------------------------
| Doctor Routes (Surgery, OT, Consultations)
|--------------------------------------------------------------------------
*/
...
Route::middleware(['auth', 'role:admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    // Pharmacy Returns & Prescriptions
    ...
    Route::get('salesReturn/{id}/approve-view', [SalesReturnController::class, 'approve'])->name('salesReturn.approve.view');
