...
Route::middleware(['auth', 'role:hr,admin,manager,hod'])->prefix('hr')->name('hr.')->group(function () {
    ...
    Route::prefix('weekends')->name('weekends.')->group(function() {
        ...
        Route::put('/{id}/restore', [WeekendController::class, 'restore'])->name('restore');
    ...
    Route::prefix('holidays')->name('holidays.')->group(function() {
        ...
        Route::put('/{id}/restore', [HolidayController::class, 'restore'])->name('restore');
    ...
    Route::prefix('leave-mappings')->name('leave-mappings.')->group(function() {
        ...
        Route::put('/{id}/restore', [LeaveMappingController::class, 'restore'])->name('restore');
    ...
    Route::prefix('compoffs')->name('compoffs.')->group(function() {
        ...
        Route::put('/{id}/restore', [CompOffController::class, 'restore'])->name('restore');
