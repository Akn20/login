...
class AccountantReportController extends Controller
{
    ...
    public function apiDailyCollection(Request $request)
    {
        /*
        |--------------------------------------------------------------------------
        | OPD COLLECTIONS
        ...
        */
        ...
        $opdQuery = $opdQuery->getQuery();

        $ipdQuery = $ipdQuery->getQuery();
        ...
        */
        ...
        $cashCollection = $collections
            ...
            ->filter(function ($item) {
                ...
                return strtolower($item->payment_mode)
                    == 'cash';
    ...
    public function apiDepartmentRevenue(Request $request)
    {
        /*
        |--------------------------------------------------------------------------
        | DATE FILTERS
        ...
        */
        ...
        return response()->json([
            ...
            'message' => 'Department revenue report fetched successfully',
            ...
            'summary' => [
                ...
                'highest_department' => $highestDepartment,
    ...
    public function apiOpdIpdRevenue(Request $request)
    {
        /*
        |--------------------------------------------------------------------------
        | DATE FILTERS
        ...
        */
        ...
        foreach ($allDates as $date) {
            ...
            $reportData->push([
                ...
                'opd_revenue'  => (float) $opdAmount,

                'ipd_revenue'  => (float) $ipdAmount,
        ...
        */
        ...
        return response()->json([
            ...
            'message' => 'OPD IPD revenue report fetched successfully',

            'summary' => [

                'total_opd_revenue' => $totalOpdRevenue,

                'total_ipd_revenue' => $totalIpdRevenue,

                'total_revenue'     => $totalRevenue,

                'difference'        => $difference,

                'highest_source'    => $highestRevenueSource,
    ...
    public function apiOutstandingDues(Request $request)
    {
        /*
        |--------------------------------------------------------------------------
        | FILTERS
        ...
        */
        ...
        $reportData = $reportData->sortByDesc('bill_date')->values();
        ...
        */
        ...
        return response()->json([
            ...
            'message' => 'Outstanding dues report fetched successfully',

            'summary' => [

                'total_outstanding' => $totalOutstanding,

                'ipd_outstanding' => $ipdOutstanding,

                'pharmacy_outstanding' => $pharmacyOutstanding,
    ...
    public function apiInsuranceSettlement(Request $request)
    {
        /*
        |--------------------------------------------------------------------------
        | MAIN QUERY
        ...
        */
        ...
        return response()->json([
            ...
            'message' => 'Insurance settlement report fetched successfully',
    ...
    public function apiRefundReport(Request $request)
    {
        /*
        |--------------------------------------------------------------------------
        | MAIN QUERY
