                ...
                <li class="nxl-item nxl-hasmenu">
                    ...
                    <ul class="nxl-submenu">
                        ...
                        <li class="nxl-item"><a href="{{ route('hr.leave-type.index') }}" class="nxl-link">Leave
                                Type</a></li>
                        <li class="nxl-item"><a href="{{ route('hr.leave-mappings.index') }}" class="nxl-link">Leave
                                Mappings</a></li>
                        <li class="nxl-item"><a href="{{ route('hr.leave-adjustments.index') }}" class="nxl-link">Leave
                                Adjustment</a></li>
