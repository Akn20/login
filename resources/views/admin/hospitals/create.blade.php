...
@section('page-title', 'Add Hospital | ' . config('app.name'))
@section('title', 'Add Hospital')

@section('content')
    <div class="page-header mb-4 d-flex align-items-center justify-content-between">
        <div class="page-header-title">
            <h5 class="m-b-10"><i class="feather-plus-square me-2"></i>Add Hospital</h5>
            <ul class="breadcrumb">
        ...
        <div class="card-body">
            <form action="{{ route('admin.hospitals.store') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        <label for="institution_id" class="form-label">Institution <span
                                class="text-danger">*</span></label>
                        <select id="institution_id" name="institution_id"
                            class="form-select @error('institution_id') is-invalid @enderror" required>
