...
@section('page-title', 'View Inventory Vendor | ' . config('app.name'))
        ...
        <div class="page-header">
            <div class="page-header-left d-flex align-items-center">
                <div class="page-header-title">
                    <h5 class="m-b-10">Inventory Vendor Details</h5>
                </div>
                <ul class="breadcrumb">
            ...
            <div class="page-header-right ms-auto d-flex gap-2">
                <a href="{{ route('admin.inventory-vendors.edit', $vendor->id) }}" class="btn btn-neutral">
                    Edit Vendor
                </a>
