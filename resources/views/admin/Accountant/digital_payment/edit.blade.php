...
<div class="container-fluid">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form method="POST"
                  action="{{ route('admin.digital-payment.update', $payment->id) }}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="payment_method"
                            ...
                            <option value="UPI" {{ $payment->payment_method == 'UPI' ? 'selected' : '' }}>
                                UPI
                            </option>
                            ...
                            <option value="Net Banking" {{ $payment->payment_method == 'Net Banking' ? 'selected' : '' }}>
                                Net Banking
                            </option>

                            <option value="Wallet" {{ $payment->payment_method == 'Wallet' ? 'selected' : '' }}>
                                Wallet
                            </option>
