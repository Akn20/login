            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.job-type.update', $jobType->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="job_type_code" class="form-control" value="{{ $jobType->job_type_code }}">
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Job Type Name</label>
                        <input type="text" name="job_type_name" class="form-control" value="{{ $jobType->job_type_name }}">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="status" class="form-control">
                            <option value="Active" {{ $jobType->status == 'Active' ? 'selected' : '' }}>
                                Active
                            </option>

                            <option value="Inactive" {{ $jobType->status == 'Inactive' ? 'selected' : '' }}>
                                Inactive
                            </option>
                        </select>
                    </div>
