            ...
            <div class="table-responsive">
                <table class="table table-hover">
                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <div class="d-flex justify-content-end gap-2">
                                        {{-- Restore Button --}}
                                        <form action="{{ route('hr.holidays.restore', $holiday->id) }}" method="POST">
                                            @csrf
                                            <button type="submit" class="btn btn-outline-success btn-icon rounded-circle btn-sm"
                                                title="Restore">
                                        ...
                                        <form action="{{ route('hr.holidays.forceDelete', $holiday->id) }}" method="POST"
                        ...
                        @empty
                            <tr>
                                <td colspan="3" class="text-center py-4">No deleted holidays found.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
